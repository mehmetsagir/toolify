        ...
        <div className="p-4 border-t border-white/5">
          <div className="space-y-4">
            ...
            <div className="text-center">
              <div className="text-[11px] text-zinc-500 font-medium">Version {appVersion}</div>
            </div>
            ...
            <button
              ...
              className="no-drag w-full flex items-center justify-center gap-2 px-3 py-2 rounded-md text-zinc-400 hover:text-white hover:bg-white/5 transition-colors duration-150 cursor-pointer group"
            ...
            >
              ...
              <span className="text-[12px] font-medium">View on GitHub</span>
            </button>
          </div>
        </div>
      </div>
